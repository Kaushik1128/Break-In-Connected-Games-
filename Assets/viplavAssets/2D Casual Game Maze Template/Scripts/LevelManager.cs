...
namespace MazeTemplate
{
    public class LevelManager : MonoBehaviour
    {
        ...
        public GameObject LockPickerPos;
        ...
        public void NextLevel()
        {
            ...
            currentLevelPrefab = Instantiate(levels[currentLevelNumber], LockPickerPos.transform.position,LockPickerPos.transform.rotation);
